...
# this project will mock a state or database for a developement server
# by setting $home as a global variable. In a production server NEVER 
# use a global variable 
$home = {}

# this class will represent our Home resource as a ruby object
class Home
  # ActiveModel (AM) is part of ruby on rails used as an ORM
  # There is a module within AM that provides validations
